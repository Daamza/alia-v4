...
def whatsapp_webhook():
    ...
    if 'asistente' in msg:
        ...
        return responder_whatsapp('Estamos derivando tus datos a un operador para terminar el ingreso. En breve serás contactado, muchas gracias.')
    if msg == 'hola':
        return responder_whatsapp('Hola! Soy ALIA. Tu asistente con IA de laboratorio.' ' Escribe Asistente en cualquier momento y serás derivado a un operador.') ('En que puedo ayudarte hoy?')
