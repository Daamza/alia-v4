...
def whatsapp_webhook():
    ...
    prompt_fb = f"Paciente:{info.get('nombre','Paciente')},Edad:{edad}\nOCR:{texto}\nPregunta:{body}\Responde a tres consignas, cuanto ayuno tiene que hacer, si tiene que recolectar o no orina y si el paciente se despide saludarlo cordialmente, invitandolo a comunicarse nuevamente."
